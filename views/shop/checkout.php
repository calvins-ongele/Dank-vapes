                                            ...
                                            <div data-block-name="woocommerce/checkout" class="wp-block-woocommerce-checkout alignwide wc-block-checkout">
                                                ...
                                                <div class="wc-block-components-sidebar-layout wc-block-checkout is-mobile">
                                                    ...
                                                    <div class="wc-block-components-main wc-block-checkout__main wp-block-woocommerce-checkout-fields-block">
                                                        <form aria-label="Checkout" class="wc-block-components-form wc-block-checkout__form">
                                                            <div></div>
                                                            ...
                                                            <fieldset class="wc-block-checkout__payment-method wp-block-woocommerce-checkout-payment-block wc-block-components-checkout-step" id="payment-method">
                                                                ...
                                                                <div class="wc-block-components-checkout-step__content">
                                                                    ...
                                                                    <div class="wc-block-components-radio-control wc-block-components-radio-control--highlight-checked wc-block-components-radio-control--highlight-checked--first-selected">
                                                                        <div class="wc-block-components-radio-control-accordion-option wc-block-components-radio-control-accordion-option--checked-option-highlighted"><label class="wc-block-components-radio-control__option wc-block-components-radio-control__option-checked" for="radio-control-wc-payment-method-options-cod"><input id="radio-control-wc-payment-method-options-cod" class="wc-block-components-radio-control__input" type="radio" name="radio-control-wc-payment-method-options" aria-describedby="radio-control-wc-payment-method-options-cod__content" aria-disabled="false" value="cod" checked="">
                                                                                <div class="wc-block-components-radio-control__option-layout">
                                                                        ...
                                                                        <div class="wc-block-components-radio-control-accordion-option"><label class="wc-block-components-radio-control__option" for="radio-control-wc-payment-method-options-mycryptocheckout"><input id="radio-control-wc-payment-method-options-mycryptocheckout" class="wc-block-components-radio-control__input" type="radio" name="radio-control-wc-payment-method-options" aria-describedby="radio-control-wc-payment-method-options-mycryptocheckout__content" aria-disabled="false" value="mycryptocheckout">
                                                                                <div class="wc-block-components-radio-control__option-layout">
                                                            ...
                                                            <div class="wc-block-checkout__actions wp-block-woocommerce-checkout-actions-block">
                                                                                    ...
                                                                                    <div class="wc-block-components-order-summary__content">
                                                                                        <div class="wc-block-components-order-summary-item">
                                                                                            <div class="wc-block-components-order-summary-item__image">
                                                                                                <div class="wc-block-components-order-summary-item__quantity"><span aria-hidden="true">2</span><span class="screen-reader-text">2 items</span></div><img src="https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-320x320.avif" alt="Ultra Sativa Prerolls Joint UK" srcset="https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-320x320.avif 320w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-300x300.avif 300w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-1024x1024.avif 1024w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-150x150.avif 150w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-768x768.avif 768w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-600x600.avif 600w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-100x100.avif 100w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK-48x48.avif 48w, https://dankbluntuk.com/wp-content/uploads/2025/08/Ultra-Sativa-Prerolls-Joint-UK.avif 1200w" sizes="48px" width="48" height="48">
                                                                                            </div>
                                                                                            <div class="wc-block-components-order-summary-item__description">
                                                                                                <h3 class="wc-block-components-product-name">Ultra Sativa Prerolls Joint UK</h3>
                                                                                            ...
                                                                                            </div><span class="screen-reader-text">Total price for 2 Ultra Sativa Prerolls Joint UK items: £57.90</span>
                                                                ...
                                                                <div class="wc-block-checkout__actions_row wc-block-checkout__actions_row--justify-flex-end"><button class="wc-block-components-button wp-element-button wc-block-components-checkout-place-order-button wc-block-components-checkout-place-order-button--full-width contained" style="" type="button">
